          ...
          <div className="modal-backdrop" onClick={cancelSort}>
            ...
            >
              ...
              <div style={{ lineHeight: 1.7, fontWeight: 700, fontSize: 14 }}>
                <p>
                  若價格明顯偏低，通常為提供單次施打服務之診所，通常是拿大劑量打小劑量，表面上價格較低，實際上未必較為划算。
                  本站認為肥胖應當成慢性病治療，並不鼓勵購買單次施打。
                </p>

                <p>
                  價格非選擇診所之唯一考量，專業有價；醫師的評估、治療規劃、後續追蹤與售後服務皆為重要因素。
                </p>

                <p>
                  此外，本站收錄之價格資訊來源眾多，無法逐一進行實地查證，請務必親自前往實體診所或藥局購買。
                  近期相關詐騙案件增加，請勿任意匯款至不明帳戶，若輕易匯款被騙本站無法負責。
                </p>
              </div>
